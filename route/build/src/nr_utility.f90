...
implicit none
INTERFACE arth
 MODULE PROCEDURE arth_r, arth_d, arth_i_i4b, arth_i_i8b
END INTERFACE
...
contains
 ...
 END FUNCTION arth_d
 ! ------------------------------------------------------------------------------------------------
 FUNCTION arth_i_i4b(first,increment,n)
 implicit none
 INTEGER(I4B), INTENT(IN) :: first,increment,n
 INTEGER(I4B), DIMENSION(n) :: arth_i_i4b
 INTEGER(I4B) :: k
 arth_i_i4b(1)=first
 if(n>1)then
  do k=2,n
   arth_i_i4b(k) = arth_i_i4b(k-1) + increment
  end do
 end if
 END FUNCTION arth_i_i4b

 FUNCTION arth_i_i8b(first,increment,n)
 implicit none
 INTEGER(I8B), INTENT(IN) :: first,increment,n
 INTEGER(I8B), DIMENSION(n) :: arth_i_i8b
 INTEGER(I8B) :: k
 arth_i_i8b(1)=first
 if(n>1)then
  do k=2,n
   arth_i_i8b(k) = arth_i_i8b(k-1) + increment
  end do
 end if
 END FUNCTION arth_i_i8b
 ! *************************************************************************************************
 ...
 INTEGER(I8B), DIMENSION(:), INTENT(OUT) :: index
 INTEGER(I8B), PARAMETER :: NN=15, NSTACK=50
 INTEGER(I8B) :: a
 INTEGER(I8B) :: n,k,i,j,indext,jstack,l,r
 INTEGER(I8B), DIMENSION(NSTACK) :: istack
 n=size(arr)
 index=arth(1_i8b,1_i8b,n)
 jstack=0
 l=1
 r=n
 do
